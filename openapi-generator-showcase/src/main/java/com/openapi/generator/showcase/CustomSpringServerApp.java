...
public class CustomSpringServerApp {
    ...
    public static void main(String[] args) {
        String inputSpec = args.length > 0 ? args[0] : "openapi-generator-showcase/generated/openapi/showcase-openapi.yaml";
        String outputDir = args.length > 1 ? args[1] : "openapi-generator-showcase/generated/spring-server";
